...
RUN apk add --no-cache --virtual=build-dependencies \
	...
	cd /opt && \
		wget -c https://tools.fengqi.me/ruTorrent-3.8.tar.gz && \
	...
	cd /opt && \
		wget https://tools.fengqi.me/rtorrent-0.9.4.tar.gz && \
	...
	rm -rf /opt/libtorrent-* /opt/rtorrent-* /opt/ruTorrent-* /opt/patch
